...
export class BaseListCtl extends BaseCtl {  
  ...
  submit() {
    this.form.pageNo=0;
    if(this.form.searchParams.roleId=="undefined" || this.form.searchParams.id=="undefined" || this.form.searchParams.bankName=="undefined" || this.form.searchParams.productName=="undefined"){
